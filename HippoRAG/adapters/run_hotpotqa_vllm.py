...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run HippoRAG on HotpotQA with OpenAI-compatible vLLM endpoint.")
    parser.add_argument("--llm-model", type=str, default="mistralai/Mistral-7B-Instruct-v0.3")
    parser.add_argument("--llm-base-url", type=str, default=os.getenv("VLLM_BASE_URL", "http://127.0.0.1:8051/v1"))
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "Example: adapter_runs/hotpotqa/index-qwen72b"
        ),
    )
    ...
    parser.add_argument("--qa-top-k", type=int, default=2)
