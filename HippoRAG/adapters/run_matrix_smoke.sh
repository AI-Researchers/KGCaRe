...
python adapters/run_conditionalqa_openai.py --llm-model gpt-4.1-nano --run-name smoke --limit 20 --ingest
...
python adapters/run_hotpotqa_openai.py --llm-model gpt-4.1-nano --run-name smoke --limit 20 --ingest
