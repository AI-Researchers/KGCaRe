...
def get_hotpot_doc_content(x):
    # doc_context_dict  = {}
    doc_context_list = x["context"]
    # for context in doc_context_list:
    #     doc_context_dict[context[0]] = context[1]
    formatted_content = "\n".join([f"Filename: {context[0]}\nContent: {context[1]}" for context in doc_context_list])
