...
def write_metadata(output_path: Path, docs_dir: Path, ref_file: Path, corpus_count: int, query_count: int) -> None:
    metadata = {
        ...
        "notes": [
            ...
            "Use existing HotpotQA answer/eval flow where possible for comparisons.",
        ],
    }
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Prepare HotpotQA artifacts for LightRAG adapters.")
